...
laws = helper.load_pickle('law2vector.pickle') #'law2vector.pickle' is of the same sturcture as votes.csv. that is a vector of all the vote results for each law
A,b = iterate(laws)
A,b = minus(A,b)
helper.init_pickle('A.pickle')
helper.init_pickle('b.pickle')
helper.dump_pickle('A.pickle', A)
helper.dump_pickle('b.pickle', b)
