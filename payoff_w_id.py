...
data={'name': names, 'id' : ids, payoff': x1, 'faction': faction, 'took_part': part}

df = pd.DataFrame.from_dict(data)
df.to_csv('payoff_w_ids.csv')
print("new payoff_w_ids.csv has created")
